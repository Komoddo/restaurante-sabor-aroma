...
class RestauranteGestion:
    ...
    def __init__(self):
        """
        Inicializa el sistema de gestión de restaurante.
        """
        RestaurantDB()
        ...
        self.Catalogo = [
            Producto(0, "Café Americano", "Café filtrado tradicional", 1.80, "Bebida", 1),
            Producto(0, "Cappuccino", "Café con leche y espuma", 2.50, "Bebida", 1),
            Producto(0, "Té de Hierbas", "Infusión natural de hierbas", 1.60, "Bebida", 1),
            Producto(0, "Té Verde", "Té verde orgánico", 1.70, "Bebida", 0),
            Producto(0, "Latte", "Café con leche espumada", 2.40, "Bebida", 1),
            Producto(0, "Mocaccino", "Café con chocolate y espuma", 2.90, "Bebida", 0),
            Producto(0, "Espresso", "Café espresso intenso", 1.30, "Bebida", 1),
            Producto(0, "Café Doble", "Doble shot de espresso", 2.10, "Bebida", 1),
            Producto(0, "Café con Leche", "Café con bastante leche", 2.00, "Bebida", 1),
            Producto(0, "Brownie Casero", "Porción de brownie con nuez", 2.90, "Postre", 1),
            ...
            Producto(0, "Muffin Arándanos", "Muffin recién horneado", 1.90, "Postre", 1),
            Producto(0, "Helado Vainilla", "Copa de helado crema vainilla", 2.10, "Postre", 0),
            Producto(0, "Ensalada César", "Lechuga, pollo y aderezo César", 4.20, "Menú", 0),
            Producto(0, "Ensalada Mixta", "Mix de hojas, tomate y zanahoria", 3.80, "Menú", 1),
            Producto(0, "Sándwich Veggie", "Pan integral con verduras grilladas", 3.80, "Menú", 1),
            Producto(0, "Sándwich de Atún", "Atún, mayonesa ligera y lechuga", 3.60, "Menú", 1),
            Producto(0, "Wrap Pollo", "Wrap de pollo a la plancha", 4.00, "Menú", 0),
            Producto(0, "Pizza Personal", "Pizza pequeña de queso y tomate", 4.90, "Menú", 1),
            Producto(0, "Hamburguesa Clásica", "Carne, queso y vegetales", 5.20, "Menú", 1),
            Producto(0, "Papas Fritas", "Porción crujiente", 1.80, "Snack", 1),
            Producto(0, "Sopa del Día", "Sopa casera según disponibilidad", 2.50, "Entradas", 0),
            Producto(0, "Jugo Naranja", "Jugo natural exprimido", 1.70, "Bebida Fría", 1),
            Producto(0, "Smoothie Frutos Rojos", "Batido de frutas y yogur", 3.10, "Bebida Fría", 0),
        ]
        self.Categorias = {}
        self.crear_categorias()
        
        # self.empleados = [
        #     ("Carlos", "Pérez", "12345678", 30, "Cocina"),
        #     ("María", "González", "87654321", 28, "Atención al Cliente"),
        #     ("Juan", "Ramírez", "11223344", 35, "Gerencia"),
        #     ("Lucía", "Fernández", "44332211", 25, "Limpieza"),
        #     ("Pedro", "Salazar", "55667788", 40, "Administración"),
        #     ("Ana", "Torres", "99887766", 32, "Cocina"),
        #     ("Luis", "Mendoza", "22334455", 29, "Atención al Cliente"),
        #     ("Carla", "Vargas", "33445566", 27, "Gerencia"),
        #     ("Miguel", "López", "44556677", 31, "Limpieza"),
        #     ("Daniela", "Campos", "55667788", 26, "Administración")
        # ]

        # self.clientes = [
        #     ("María", "González Pérez", "987654321", "maria.gonzalezp@gmail.com"),
        #     ("Juan", "Ramírez Torres", "912345678", "juan.ramirezto@gmail.com"),
        #     ("Lucía", "Fernández Rojas", "954321678", "lucia.fernandezr@gmail.com"),
        #     ("Pedro", "Salazar Quiroz", "998877665", "pedro.salazarq@gmail.com"),
        #     ("Ana", "Torres Delgado", "934567812", "ana.torresd@gmail.com"),
        #     ("Luis", "Mendoza López", "987123654", "luis.mendozal@gmail.com"),
        #     ("Carla", "Vargas Castillo", "945612378", "carla.vargasc@gmail.com"),
        #     ("Miguel", "López Herrera", "976543210", "miguel.lopezh@gmail.com"),
        #     ("Daniela", "Campos Rivera", "956781234", "daniela.camposr@gmail.com"),
        #     ("José", "Pérez Aguilar", "934125678", "jose.perezag@gmail.com"),
        #     ("Valeria", "Rojas Medina", "987456321", "valeria.rojasm@gmail.com"),
        #     ("Andrés", "Suárez Ramírez", "912398765", "andres.suarezr@gmail.com"),
        #     ("Gabriela", "Chávez Flores", "956234781", "gabriela.chavezf@gmail.com"),
        #     ("Roberto", "Morales Vega", "945673218", "roberto.moralesv@gmail.com"),
        #     ("Patricia", "Herrera Campos", "987612345", "patricia.herrerac@gmail.com"),
        #     ("Sofía", "Cruz Andrade", "954789123", "sofia.cruza@gmail.com"),
        #     ("Fernando", "Silva Núñez", "976128345", "fernando.silvan@gmail.com"),
        #     ("Rocío", "Delgado Ponce", "912764389", "rocio.delgadop@gmail.com"),
    ...
    # ========================================================================
    # FUNCIONES DEL CATÁLOGO Y PRODUCTOS
    # ========================================================================
    ...
    def mostrar_catalogo(self):
        ...
        print("\n" + "="*60)
        print("CATÁLOGO PRODUCTOS - RESTAURANTE")
        print("="*60)
        ...
        for categoria, items in categorias.items():
            ...
            print("-" * 40)
            for p in items:
                print(f"• {p.nombre:<25} | {p.descripcion:<45} | S/{p.precio:>6.2f}")
    ...
    def agregar_al_carrito(self, nombre: str, cantidad: int) -> bool:
        ...
        try:
            ...
            if not filtrado:
                ...
                for p in filtrado:
                    print(f"• {p.id_producto}     {p.nombre:<25} | {p.descripcion:<45} |    {p.categoria:<45}  |   S/{p.precio:>6.2f}")
    ...
    def gestionar_reservas():
        # Aquí se implementaría la lógica para gestionar reservas
        # incluyendo agregar, modificar, cancelar y ver reservas.
        while True:
            """Función para gestionar reservas de mesas."""
            print("\n🔖 GESTIÓN DE RESERVAS - RESTAURANTE")
            print("="*60)
            print("Funcionalidad en desarrollo...")
            print("\n" + "="*60)
            print("1. 💰 Mostrar Lista de Reservas")
    ...
    def Agregar_reserva():
        # Aquí se implementaría la lógica para agregar una reserva
        print("\n🔖 AGREGAR RESERVA")
        print("="*60)

        self.mostrar_mesas()
        mesa_seleccionada = input("Seleccione el número de mesa: ").strip()
        ...
        cliente_seleccionado = int(input("Seleccione el número de cliente: ")) - 1
    ...
    def insertar_datos_iniciales(self, cursor):
        """Inserta datos de prueba si las tablas están vacías."""
    ...
    def productos_mas_vendidos(self, limite: int = 5):
        ...
        try:
            ...
            print(f" Error en consulta productos más vendidos: {e}")
    ...
    def productos_stock_critico(self, limite_stock: int = 10):
        ...
        try:
            ...
            print(f"\n PRODUCTOS CON STOCK CRÍTICO (≤ {limite_stock})")
            print("="*60)
            ...
            print(f" Error en consulta stock crítico: {e}")
    ...
    def menu_actualizaciones(self):
        ...
        while True:
            ...
            print("="*60)
            print("1. 💰 Actualizar Precios de Productos")
            print("2. 📦 Actualizar Stock/Inventario")
            print("3. 👥 Gestionar Información de Clientes")
            print("4. 📋 Agregar Nuevos Productos")
            print("5. 📅 Programar Actualizaciones Futuras")
            print("6. 🔍 Ver Actualizaciones Pendientes")
            print("7. 📊 Historial de Cambios (Auditoría)")
    ...
    def menu_gestionar_mesas(self):
        """Menú para gestionar mesas del restaurante."""
        while True:
            print("\n" + "="*50)
    ...
    def mostrar_todas_mesas(self):
        ...
        print("="*70)
        print(f"{'Num':<5} {'Capacidad':<12} {'Estado':<15} {'Descripción':<30}")
        print("-"*70)
    ...
    def agregar_mesa(self):
        ...
        try:
            ...
            print(f"\n📋 RESUMEN DE LA NUEVA MESA:")
            print(f"Número: {numero_mesa}")
    ...
    def insertar_mesa_bd(self, numero, capacidad, estado):
        ...
        try:
            ...
            print(f"❌ Error al guardar mesa en BD: {e}")
    ...
    def cambiar_estado_mesa(self):
        ...
        numero_mesa = input("\nIngrese el número de mesa: ").strip()
        ...
        try:
            ...
            if 0 <= opcion < len(estados_disponibles):
                ...
                print(f"✅ Mesa {numero_mesa}: {mesa[2]} → {nuevo_estado}")
            else:
                print("❌ Opción inválida")
    ...
    def eliminar_mesa(self):
        ...
        numero_mesa = input("\nIngrese el número de mesa a eliminar: ").strip()
        mesa = next((m for m in self.mesas if m[0] == numero_mesa), None)
        ...
        if mesa[2] == "Ocupado":
            print(f"❌ No se puede eliminar la mesa {numero_mesa}, está ocupada")
            return
        ...
        if confirmar == 's':
            ...
            print(f"✅ Mesa {numero_mesa} eliminada exitosamente")
        else:
            print("❌ Operación cancelada")
    ...
    def obtener_mesas_disponibles(self, num_personas: int) -> List[Tuple]:
        ...
        Args:
            num_personas: Número de personas que necesitan mesa
        ...
        if mesas_disponibles:
            # Ordenar por capacidad ascendente para ofrecer la mesa más pequeña disponible
    ...
    def ver_mesas_por_estado(self):
        ...
        for estado in sorted(mesas_por_estado.keys()):
            ...
            print("-" * 40)
            for numero, capacidad in mesas:
                icono = "🟢" if estado == "Disponible" else "🔴" if estado == "Ocupado" else "🟡"
    ...
    def submenu_actualizar_precios(self):
        ...
        print("2. Actualizar múltiples productos")
        print("3. Aplicar aumento/descuento porcentual por categoría")
        print("0. Cancelar")
    ...
    def actualizar_precio_individual(self):
        ...
        confirmar = input(f"\n¿Desea actualizar el precio de '{nombre}'? (s/n): ").lower()
        if confirmar != 's':
            print(" Operación cancelada")
            return
        ...
        try:
            ...
            if 0 <= seleccion < len(categorias):
                ...
                for nombre, descripcion, precio, _ in productos_categoria:
                    print(f"• {nombre:<25}  | • {descripcion:<25}  | S/{precio:.2f}")
    ...
    #     """Submenú para actualizar inventario/stock."""
    #     print("\n" + "="*50)
    #     print("📦 ACTUALIZACIÓN DE STOCK/INVENTARIO")
    #     print("="*50)

    #     print("1. Actualizar stock de un producto")
    #     print("2. Entrada de mercancía (agregar stock)")
    #     print("3. Ajuste de inventario (múltiples productos)")
    ...
    #         confirmar = input("¿Confirmar cambio? (s/n): ").lower()
    #         if confirmar == 's':
    ...
    def entrada_mercancia(self):
        """Registra entrada de nueva mercancía."""
        ...
        while True:
            ...
            if opcion == "1":
                ...
                if productos_entrada:
                    ...
                    for prod in productos_entrada:
                        print(f"• {prod['nombre']}: {prod['stock_anterior']} → {prod['stock_nuevo']} (+{prod['cantidad']})")

                    confirmar = input(f"\n¿Procesar entrada de {total_productos} producto(s)? (s/n): ").lower()
                    if confirmar == 's':
    ...
    def registrar_entrada_mercancia(self, productos_entrada):
        """Registra la entrada de mercancía en un archivo de log."""
        try:
            fecha_hoy = datetime.datetime.now().strftime('%Y%m%d')
            archivo = f"datos/entradas_{fecha_hoy}.txt"

            with open(archivo, 'a', encoding='utf-8') as f:
                f.write(f"ENTRADA DE MERCANCÍA - {datetime.datetime.now().strftime('%d/%m/%Y %H:%M:%S')}\n")
                f.write("-" * 50 + "\n")
                for prod in productos_entrada:
                    f.write(f"{prod['nombre']}: +{prod['cantidad']} unidades (stock: {prod['stock_anterior']} → {prod['stock_nuevo']})\n")
                f.write("=" * 50 + "\n\n")
    ...
    def ajuste_inventario_multiple(self):
        """Permite ajustar el stock de múltiples productos."""
        print("\n AJUSTE DE INVENTARIO MÚLTIPLE")
        print("-" * 45)
        ...
        while True:
            ...
            for prod in productos_a_ajustar:
                print(f"  • {prod['nombre']}: {prod['stock_anterior']} → {prod['stock_nuevo']}")
            ...
            if opcion == "1":
                ...
                if productos_a_ajustar:
                    ...
                    for prod in productos_a_ajustar:
                        ...
                        print(f"• {prod['nombre']}: {prod['stock_anterior']} → {prod['stock_nuevo']} ({diferencia:+d})")

                    confirmar = input(f"\n¿Aplicar ajustes a {total_productos} producto(s)? (s/n): ").lower()
                    if confirmar == 's':
    ...
    def submenu_agregar_productos(self):
        """Submenú para agregar nuevos productos/servicios."""
        ...
        try:
            ...
            for i, cat in self.Categorias.items():
                print(f"{i}. {cat}")
            print(f"{len(self.Categorias) + 1}. Nueva categoría")
    ...
    def submenu_programar_actualizaciones(self):
        """Submenú para programar actualizaciones futuras."""
        print("\n📅 PROGRAMAR ACTUALIZACIONES FUTURAS")
        print("-" * 45)

        print("1. Programar cambio de precios")
        print("2. Programar reposición de stock")
    ...
    def programar_cambio_precios(self):
        ...
        try:
            fecha_str = input("Fecha de aplicación (YYYY-MM-DD): ").strip()
            ...
            if ajustes:
                ...
                confirmar = input("\n¿Confirmar programación? (s/n): ").lower()
                if confirmar == 's':
                    self.guardar_actualizacion_programada("precios", fecha_str, ajustes)
                    print(f" Actualización programada para {fecha_str}")
                else:
                        ...
                        if '|' in linea:
                            ...
                            if fecha_prog > fecha_hoy and programacion.get('estado') == 'programado':
                                if not pendientes_encontradas:
                                    print("📅 Actualizaciones pendientes:")
    ...
    def ver_historial_cambios(self):
        ...
        try:
            ...
            if cambios:
                print(f"\n📊 ÚLTIMOS {len(cambios)} CAMBIOS DE PRECIOS:")
                print("-" * 80)
                ...
                for fecha_cambio, producto, precio_ant, precio_nuevo, fecha_reg in cambios:
                    ...
                    simbolo = "↗️" if diferencia > 0 else "↘️" if diferencia < 0 else "➡️"
        ...
        try:
            ...
            for i, (nombre, precio, stock_actual, categoria) in enumerate(self.catalogo):
                if nombre in productos_stock:
                    ...
                    self.catalogo[i] = (nombre, precio, nuevo_stock, categoria)
                    actualizados += 1
                    print(f" {nombre}: Stock {stock_actual} → {nuevo_stock}")
            ...
            print(f" Se actualizó el stock de {actualizados} productos")
            return True
    ...
    def guardar_actualizacion_programada(self, tipo: str, fecha: str, datos: Dict):
        """Guarda una actualización programada."""
        try:
            programacion = {
                'fecha': fecha,
                'tipo': tipo,
    ...
    def generar_graficos_analisis(self):
        ...
        try:
            ...
            plt.title('Ventas por Día - Veterinaria')
            plt.xlabel('Fecha')
            plt.ylabel('Total (S/)')
            ...
            print(" Gráfico de ventas generado en reportes/graficos/")
    ...
    def menu_principal(self):
        """Menú principal mejorado que incluye el submenú de actualizaciones."""
        while True:
            print("\n" + "="*50)
            print("MENÚ PRINCIPAL - RESTAURANTE")
            print("="*50)
            ...
            print("7. Reportes y Análisis (SQL & Gráficos)")
            print("8. 🔄 ACTUALIZACIONES (Precios, Stock, etc.)")  # ← NUEVA OPCIÓN
            ...
            try:
                ...
                if opcion == "111":
                    num_personas = int(input("Ingrese el número de personas: ").strip())
                    ...
                    if filtrados:
                        for p in filtrados:
                            print(f"• {p.nombre:<25} | {p.descripcion:<45} |    {p.categoria:<45}  |   S/{p.precio:>6.2f}")
                    else:
                ...
                elif opcion == "8":  # ← NUEVA FUNCIONALIDAD
...
# ============================================================================
# FUNCIONES DE DEMOSTRACIÓN Y EJEMPLO
# ============================================================================
...
def demo_sistema_completo():
    """Demostración completa del sistema con datos de ejemplo."""
    print(" INICIANDO DEMOSTRACIÓN DEL SISTEMA DE VETERINARIA")
    print("="*60)
    ...
    print("\n📋 SIMULANDO VENTAS DE EJEMPLO...")

    # Venta 1: Cliente premium
    vet.agregar_al_carrito("Consulta General", 1)
    vet.agregar_al_carrito("Vacuna Antirrábica", 2)
    ...
    vet.finalizar_compra(1)  # María González (regular)

    print("\n📊 GENERANDO REPORTES Y ANÁLISIS...")
    vet.productos_mas_vendidos()
    vet.ventas_por_cliente()
    vet.productos_stock_critico()
    vet.generar_graficos_analisis()

    print("\n💡 DEMOSTRANDO SISTEMA DE ACTUALIZACIONES...")
    # Ejemplo de actualización de precio
    print("📝 Actualizando precio de 'Consulta General' de S/80.00 a S/85.00")
    ajustes = {"Consulta General": 85.0}
    fecha_hoy = datetime.datetime.now().strftime('%Y-%m-%d')
    vet.actualizar_precios_por_fecha(fecha_hoy, ajustes)

    # Ejemplo de actualización de stock
    print("📦 Agregando stock: Vacuna Antirrábica +10 unidades")
    stock_updates = {"Vacuna Antirrábica": 35}  # 25 + 10
    vet.actualizar_stock_inmediato(stock_updates)

    print("\n✅ DEMOSTRACIÓN COMPLETADA")
    print("📁 Revise las carpetas:")
    print(" - reportes/graficos/ (gráficos generados)")
...
def demo_actualizaciones_interactivo():
    """Demostración específica del sistema de actualizaciones."""
    print("🔄 DEMO - SISTEMA DE ACTUALIZACIONES INTERACTIVO")
    print("=" * 50)
    ...
    # 1. Actualización de precio individual
    print("\n1️⃣ Ejemplo: Actualización de precio individual")
    ...
    # print("\n2️⃣ Ejemplo: Entrada de mercancía")
    ...
    # 3. Ajuste por categoría
    print("\n3️⃣ Ejemplo: Ajuste de precios por categoría")
    ...
    print("\n📋 Estado final del catálogo (después de las actualizaciones):")
    res.mostrar_catalogo()

    print("\n📊 Consultando historial de cambios:")
    res.ver_historial_cambios()

    print("\n✅ Demo de actualizaciones completado")
    print("💡 Tip: En el menú principal, usa la opción 8 para acceder a todas las funciones de actualización")

    return res

def main():
    # """Función principal que ejecuta el sistema."""
    print("BIENVENIDO AL SISTEMA DE GESTIÓN PARA RESTAURANTE")
    print("="*60)
    print("Opciones:")
    print("1. Ejecutar demostración completa")
    print("2. Demo específico de actualizaciones")
    ...
    try:
        ...
        if opcion == "1":
            ...
            continuar = input("\n¿Desea continuar con el menú interactivo? (s/n): ").lower()
            if continuar == 's':
                res.menu_principal()

        elif opcion == "2":
            # Demo específico de actualizaciones
...
"""
📚 GUÍA PARA ESTUDIANTES - SISTEMA DE GESTIÓN VETERINARIA COMPLETO

🔹 CARACTERÍSTICAS DEL SISTEMA MEJORADO:

1. MÓDULO 1: SISTEMA BASE EN PYTHON
...
2. MÓDULO 2: BASE DE DATOS SQLITE
...
3. MÓDULO 3: MANEJO DE ARCHIVOS
   - Persistencia en archivos .txt y .csv
   - Sistema de respaldo automático
   - Estructura de carpetas organizada
   - Logs de entrada de mercancía
...
1. ACTUALIZACIÓN DE PRECIOS:
   ...
   ✅ Múltiple (varios a la vez)
   ✅ Por categoría (con porcentajes)
   ✅ Programadas para fechas futuras
   ✅ Historial de cambios (auditoría)
...
MENÚ PRINCIPAL → Opción 8 → MENÚ DE ACTUALIZACIONES
...
🚀 PARA EJECUTAR:
1. Copia todo el código en un archivo .py
2. Ejecuta: python archivo.py
3. Selecciona la opción deseada:
   - Opción 1: Demo completa
   - Opción 2: Demo de actualizaciones
   - Opción 3: Sistema interactivo
   - Opción 4: Solo inicializar

💡 CONSEJOS PARA ESTUDIANTES:
- Revisen cada función para entender su propósito
- Modifiquen los datos de ejemplo para su negocio elegido
- Experimenten con las diferentes opciones de actualización
- Analicen cómo se integran todos los módulos
- Usen el sistema de auditoría para rastrear cambios

🎯 CARACTERÍSTICAS DESTACADAS:
- Interfaz completamente interactiva
- Validaciones robustas en todas las entradas
- Confirmaciones paso a paso
- Resúmenes antes de aplicar cambios
- Sistema de auditoría completo
